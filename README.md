...
- **2026-09-13** - 升级为购物清单全量版本：748 把武器 / 8412 条组合（白弹 2946 + 绿弹 2090 + 威能 3131 + 其他 245），基于 Bungie 中文 Manifest 重新解析全部武器与 Perk hash；同步重建两个 hash 映射表；移除旧 CSV 源表（内容已被购物清单全量覆盖）
